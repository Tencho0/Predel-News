...
public class NewsTagController : RenderController
{
    ...
    public NewsTagController(
        ILogger<NewsTagController> logger,
    ...
    public override IActionResult Index()
    {
        ...
        var tagName = content.Value<string>(PropertyAliases.TagName) ?? content.Name ?? "";
        ...
        var articles = newsRoot?.Children?
            ...
            .Where(a =>
            {
                var tags = a.Value<IEnumerable<IPublishedContent>>(PropertyAliases.Tags);
                return tags?.Any(t => t.Id == content.Id) == true;
            })
        ...
        {
            PageTitle = tagName,
            SeoTitle = content.Value<string>(PropertyAliases.SeoTitle) ?? tagName,
            ...
            [
                ...
                new BreadcrumbItem { Name = "Тагове", Url = "/tag" },
                new BreadcrumbItem { Name = tagName },
            ],
        };
        ...
        ViewBag.SeoTitle = content.Value<string>(PropertyAliases.SeoTitle) ?? tagName;
